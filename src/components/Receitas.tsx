              ...
              <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  ...
                  <DialogFooter>
                    ...
                    <Button className="bg-green-600 hover:bg-green-700" onClick={saveReceita} disabled={isSaving}>
                  ...
                  <TableRow key={receita.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        <Button size="sm" variant="ghost" onClick={() => handleViewDetails(receita)} title="Visualizar">
                          <Eye className="w-4 h-4" />
                        </Button>
                        <Button size="sm" variant="ghost" onClick={() => handleEdit(receita)} title="Editar">
                          <Pencil className="w-4 h-4" />
                        </Button>
                        <Button size="sm" variant="ghost" onClick={() => handleDelete(receita.id)} className="text-red-600 hover:text-red-700" title="Excluir">
